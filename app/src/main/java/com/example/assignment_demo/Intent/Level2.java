...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finish.setOnClickListener(view -> {
            ...
            if(ans1id.equals("2131296615") && ans2id.equals("2131296620")){
                anstxt.setText("100% passed");
            }else if(ans2id != "2131296620"&& ans1id.equals("2131296615") || ans2id.equals("2131231068") && ans1id!="2131231063"){
                anstxt.setText("50% passed");
            }else{
                anstxt.setText("Quiz Failed Try again");
            }
        });
    }
